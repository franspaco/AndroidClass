 ...
 */
public class SearchBrand extends LayeredFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootview = inflater.inflate(R.layout.fragment_search_brand, container, false);

        results = rootview.findViewById(R.id.results_list1);

        EditText et = rootview.findViewById(R.id.brandNameSearch);
